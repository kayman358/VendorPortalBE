    ...
    <head>
     ...
     <body>
        ...
        <div class="container">
            ...
            <center><h4>You might have probably sent the wrong information to the server, kindly click the back button and check your form to ensure no special characters are sent along.</h4></center>
