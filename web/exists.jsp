    ...
    <head>
     ...
     <body>
        ...
        <div class="container">
            ...
            <center><h2><strong>User Account already Exists</strong></h2></center><br />
            
            <center><h4><div style="color:red; font-weight: bolder">The user has been created on this platform earlier, kindly advise user to login with windows credentials.</div></h4></center>
