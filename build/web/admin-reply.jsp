    ...
    <head>
     ...
     <body>
        ...
        <div class="container">
            ...
            <center><h2><strong>Account Locked Temporarily</strong></h2></center><br />
            
            <center><h4><div style="color:red; font-weight: bolder">This account is currently active on a different Machine or Browser, please log off from your previous session if you want to continue this session.</div></h4></center>
