...
<!DOCTYPE html>
    ...
    <head>
       ...
       <title>Success - FBN Vendor Portal</title>
     ...
     <body>
        ...
        <div class="container">
            ...
            <center><h2><strong>Thank you!!!</strong></h2></center><br />
            
            <center><h2><strong>${created}</strong> has been successfully Created.</h2></center>
            <center><h3>Kindly advise user to login with windows credentials.</h3></center>
