    ...
    <head>
     ...
     <body>
        ...
        <div class="container">
            ...
            <center><h2><strong>Invalid Selection</strong></h2></center><br />
            
            <center><h4><div style="color:red; font-weight: bolder">Error: Please select atleast one vendor.</div></h4></center>
