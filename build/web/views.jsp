...
<html>
  ...
  window.onunload=function(){null};
    ...
    <body>
        ...
        <div class="container">
            <h1 class="page-header">List of Second Level Unconfirmed Suppliers (iSupplier Module)</h1>
            <br /><br />
                ...
                <c:forEach var="row" items="${result6.rows}">
                   ...
                   <tr>
                    ...
                    <td>
                            ...
                            <input name="confirm" class="confirm" type="checkbox"  value="${row.id}" onchange="confirmVendor()">
