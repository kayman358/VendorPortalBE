...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/FBNServices/Service.asmx?disco" />
    ...
    <div id="content">
      ...
      <span>
          ...
          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="Service.asmx?WSDL">Service Description</a>. </p>
              ...
              <li>
                <a href="Service.asmx?op=ADAuthenticator">ADAuthenticator</a>
              ...
              <li>
                <a href="Service.asmx?op=ADUserDetails">ADUserDetails</a>
              ...
              <li>
                <a href="Service.asmx?op=ADValidateUser">ADValidateUser</a>
              ...
              <li>
                <a href="Service.asmx?op=GetGroups">GetGroups</a>
